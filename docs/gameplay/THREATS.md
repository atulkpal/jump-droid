...
| **Heat Bat** | `ENT_HEAT_BAT` | Cloud, Upper Atmos, Foundry | **Complete** | 4-state AI: SEARCHING, ATTACKING, ORBITING, FLEEING | 10–20 damage; accelerated dive when player heat ≥ 70% | Dark silhouette with red body/wing glow when heat-triggered; heat-distortion haze; ember trail during dive; wing-beat shadow; eyes glow red when heat ≥ 70% |
