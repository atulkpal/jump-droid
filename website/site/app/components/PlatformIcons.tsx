...
export function ItchIoIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <rect x="0.5" y="0.5" width="23" height="23" rx="5" fill="#FA5C5C" fillOpacity="0.18" stroke="#FA5C5C" strokeWidth="1.5" />
      <circle cx="12" cy="8" r="1.5" fill="#FA5C5C" />
      <path d="M12 11v7" stroke="#FA5C5C" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}
