...
enum class GameState {
    TITLE, MAIN_MENU, HANGAR, LOADOUT, ARCHIVE, ABOUT, LEADERBOARD, PLAYING, GAMEOVER, TUTORIAL, SETTINGS, PAUSED, HELP, UNLOCK, MISSIONS, ASCENSION_PROTOCOL, SHOP, CONTINUE_READY, ZEN, EXPEDITION_REWARDS, MULTIPLAYER
}
