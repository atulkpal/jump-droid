...
class GameEngine(
    ...
    fun handleLanding(platform: Platform?, yTop: Float) {
        ...
        if (platform != null) {
            ...
            when (platform.type) {
                ...
                PlatformType.FUEL -> {
                    player.velocityY = com.example.jump_droid.Constants.LANDING_BOUNCE_VELOCITY
    ...
    fun restartGame() {
        ...
        player.maxFuel = com.example.jump_droid.Constants.BASE_FUEL_CAPACITY * player.rocketType.fuelMult
        player.fuel = player.maxFuel
        ...
        player.maxHeat = com.example.jump_droid.Constants.MAX_HEAT * player.rocketType.heatMult
